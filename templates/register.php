            ...
            <main class="content__main">
                ...
                <form class="form" action="register.php" method="post">
                    <div class="form__row">
                        ...
                        <input class="form__input <?=$classname;?>" type="text" name="email" id="email" value="<?=(isset($signup['email'])) ? $signup['email'] : '';?>" placeholder="Введите e-mail">
                    ...
                    <div class="form__row">
                        ...
                        <input class="form__input <?=$classname;?>" type="password" name="password" id="password" value="<?=(isset($signup['password'])) ? $signup['password'] : '';?>" placeholder="Введите пароль">
                    </div>
                    ...
                    <div class="form__row">
                        ...
                        <input class="form__input <?=$classname;?>" type="password" name="name" id="name" value="<?=(isset($signup['name'])) ? $signup['name'] : '';?>" placeholder="Введите пароль">
                    </div>
